...
export const h1 = (props) => {
  return <Heading as="h1" className="text-5xl font-bold" {...props}></Heading>
}

export const h2 = (props) => {
  return <Heading as="h2" className="text-3xl my-6 font-bold" {...props}></Heading>
}

export const h3 = (props) => {
  return <Heading as="h3" className="text-2xl my-6 font-bold" {...props}></Heading>
}

export const h4 = (props) => {
  return <Heading as="h4" className="text-1xl my-5 font-bold" {...props}></Heading>
}
